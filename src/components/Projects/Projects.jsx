...
function Projects() {
  ...
  return (
    <div className="flex gap-[50px] items-center justify-center leading-[1.5em] h-screen w-full transition duration-[0.5s]">
      {/* <motion.div
    ...
    > */}
      <div className="item flex flex-col justify-between text-[#eb904b] w-[285px] h-[450px] bg-[#5a84a2] rounded-[10px] p-[10px_5px] shadow-[0px_1px_2px_0px_rgba(60,64,67,0.3),0px_1px_3px_1px_rgba(60,64,67,0.2)] relative cursor-crosshair">
        <div className="layer rounded-[inherit] h-[400px] p-[20px] shadow-[0px_1px_2px_rgba(0,0,0,0.07)_0px_2px_4px_rgba(0,0,0,0.07)_0px_4px_8px_rgba(0,0,0,0.07)_0px_8px_16px_rgba(0,0,0,0.07)_0px_16px_32px_rgba(0,0,0,0.07)_0px_32px_64px] relative left-[10px]">
      ...
      <div className="flex justify-end relative w-[25%] h-[80%] transition-[0.5s_ease-in-out]">
        <img
